...
# ── Run metadata ─────────────────────────────────────────────────────────────
RUN_ID    = os.environ.get("RUN_ID", "lgb_rolling56_lag56")
HYPOTHESIS = (
    "Add 56-day rolling mean/std features and lag_56 to capture longer-term "
    "seasonal patterns (annual effects visible at ~8 weeks). The 56-day window "
    "should better capture slow-moving trends and seasonal baselines that shorter "
    "windows miss, potentially reducing WRMSSE on items with strong weekly seasonality."
)
