...
# ── Run metadata ─────────────────────────────────────────────────────────────
RUN_ID    = os.environ.get("RUN_ID", "rolling_stats_exp")
HYPOTHESIS = (
    "ROLLING_STATS_EXPANSION: Add comprehensive rolling statistics beyond basic mean/std. "
    "Include rolling min/max/quantiles over windows [7, 14, 28] and expanding window stats "
    "to capture seasonal patterns and sales volatility. This should help the model better "
    "understand product behavior ranges and cyclical patterns that simple lags miss."
)
