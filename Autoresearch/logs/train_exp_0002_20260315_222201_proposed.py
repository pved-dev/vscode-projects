...
HYPOTHESIS = (
    "Baseline run with full feature set: lags including lag_365, same-weekday "
    "rolling means, EWMA features, price features, target encodings, zero_sale_streak. "
    "LightGBM with tweedie objective (power=1.5), num_leaves=256, lr=0.04, "
    "min_child_samples=100, lambda_l2=1.0, lambda_l1=0.1. "
    "This is the first run to establish a baseline WRMSSE score."
)
