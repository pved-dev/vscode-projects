...
# ── Run metadata ─────────────────────────────────────────────────────────────
RUN_ID    = os.environ.get("RUN_ID", "extended_lag_features")
HYPOTHESIS = (
    "EXTENDED_LAG_FEATURES: Add more comprehensive lag features including "
    "longer-term lags [35, 42, 49, 56] and intermediate lags [3, 10, 21] to "
    "better capture seasonal patterns, weekly cycles, and medium-term trends. "
    "This should help the model understand complex temporal dependencies in "
    "retail sales data, particularly monthly and bi-weekly patterns."
)
...
print("[train] Engineering extended lag features …")

# ── 2a. Extended lag features - comprehensive set
LAG_DAYS = [3, 7, 10, 14, 21, 28, 35, 42, 49, 56]
for lag in LAG_DAYS:
...
FEATURE_COLS = [
    ...
    "lag_3", "lag_7", "lag_10", "lag_14", "lag_21", "lag_28", "lag_35", "lag_42", "lag_49", "lag_56",
