...
HYPOTHESIS = (
    ...
    "price features, target encoding. Use Tweedie objective, num_leaves=64, "
    "learning_rate=0.05, n_estimators=800 with early stopping. "
    "No experimental features. Establish a clean baseline score."
)
