...
# ── Run metadata ─────────────────────────────────────────────────────────────
RUN_ID    = os.environ.get("RUN_ID", "baseline_lgb")
HYPOTHESIS = (
    "BASELINE_LGB: Establish baseline with core LightGBM model using essential "
    "lag features (7, 14, 28 days), rolling statistics (7, 28 day windows), "
    "price features, and target encoding for key categorical variables."
)
