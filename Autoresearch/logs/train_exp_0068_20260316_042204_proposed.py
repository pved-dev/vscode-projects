...
HYPOTHESIS = (
    "Run same feature set as current best LightGBM through XGBoost (reg:tweedie), "
    "then blend XGBoost predictions (0.4) with LightGBM Model A (0.6). "
    "XGBoost uses tree_method=hist for speed, same feature set, tweedie objective. "
    "This tests whether XGBoost diversity improves on the LightGBM-only blend."
)
